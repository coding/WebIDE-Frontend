...
修复面包屑溢出 BUG（打开的文件目录过深将界面撑出）

修复已删除工作空间所有者显示 undefined

修复关闭终端再打开，前端没有自动重连 terminal 的问题

修复插件 willmount 中无法及时读取已缓存的设置项的问题

## 2018/12/05 更新 v3.4.3

...
import { fetchPackageList, fetchPackage, togglePackage } from '../Package/actions';
const Card = (props) => {
    return (
        <div className="card">
            <div className="title">
            ...
            <div className="buttons">
                <div className="label">
                    ...
                    <button onClick={e => props.dispatch(togglePackage(props.name, !props.enabled))}>
...
export default connect((state) => {
    const {
        PackageState: { localPackages = {} }
    } = state;

    const data = Object.keys(localPackages)
    .map((key) => ({

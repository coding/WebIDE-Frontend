...
import { CodeMirrorAdapter, Selection, UndoManager, TextOperation, WrappedOperation  } from 'utils/ot'
...
CodeMirrorEditor.extends = function (mixinFactory) {
  function SubClass (props, context) {
    const self = new CodeMirrorEditor(props, context)
    const mixinConfigs = mixinFactory.call(self)
    const { constructor } = mixinConfigs

    if (constructor) constructor.call(this, props, context)
    return self
  }
  return SubClass
}
